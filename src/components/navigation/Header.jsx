...
const Header = () => {
  ...
  return (
    <header className=" z-10 fixed bg-white top-0 h-20 w-full font-roboto font-bold text-base text-primary40 flex flex-row items-center border-blue-700 border-2, shadow-light px-2 justify-between md:justify-around">
        {/* logo */}
        <div className='w-12 h-12'>
            ...
            {/* header links */}
        <ul className={`md:flex md:flex-row items-center ${!toggle_menu ? 'hidden' : 'absolute right-0 top-0 flex-col w-[80%] bg-white p-4 mt-20 rounded-b-md transition-all duration-500 ease-in-out'}`}>
