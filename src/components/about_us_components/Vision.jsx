...
const Vision = () => {
  return (
    <div className="flex flex-col items-center  bg-primary-green gap-3 py-6">
    <p className="font-bold  bg-white text-primary-green py-2 px-11">
      OUR VISION
    </p>
    <p className="font-medium text-white max-w-4xl mb-4 mt-2">
